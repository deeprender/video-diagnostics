  ...
  <div class="container">
    ...
    <div class="video-compare-container" ref="container" @mousedown="startSeeking">
      ...
      <video class="video-main" :class="{ 'fullscreen': isFullscreen }" autoplay muted ref="mainVideo" preload="auto"
        @loadedmetadata="videoLoaded" @error="videoError">
      ...
      <div class="video-clipper" ref="clipper">
        ...
        <video class="video-clipped" :class="{ 'fullscreen': isFullscreen }" autoplay muted preload="auto"
          ref="clippedVideo" @loadedmetadata="videoLoaded" @error="videoError">
...
.progress-container {
  ...
  z-index: 3;
  /* Updated Z-index to be above the video */
}
...
.progress-bar {
  ...
  width: 0%;
  /* This will be controlled by Vue.js */
}
...
.split-line {
  ...
  /* Adjust the height to account for the progress bar */
